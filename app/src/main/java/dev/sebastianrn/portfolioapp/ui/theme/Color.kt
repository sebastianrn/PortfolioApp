...
val GoldEnd = Color(0xFFFFA000)
val ProfitGreen = Color(0xFF2E7D32) // Slightly darker for light mode contrast
val LossRed = Color(0xFFC62828)     // Slightly darker for light mode contrast
